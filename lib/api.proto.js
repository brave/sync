...
(function(global, factory) { /* global define, require, module */
    ...
    $root.api = (function() {
        ...
        api.Credentials = (function() {
             ...
             * @property {api.Credentials.IAws} [aws] Credentials aws
             * @property {api.Credentials.IS3Post} [s3Post] Credentials s3Post
             * @property {string} [bucket] Credentials bucket
             * @property {string} [region] Credentials region
             */
            ...
            Credentials.verify = function verify(message) {
                ...
                if (message.s3Post != null && message.hasOwnProperty("s3Post")) {
                    error = $root.api.Credentials.S3Post.verify(message.s3Post);
                    if (error)
                        return "s3Post." + error;
                }
                if (message.bucket != null && message.hasOwnProperty("bucket"))
            ...
            Credentials.Aws = (function() {
                 ...
                 * @memberof api.Credentials
                 * @interface IAws
                 * @property {string} [accessKeyId] Aws accessKeyId
                 * @property {string} [secretAccessKey] Aws secretAccessKey
                 * @property {string} [sessionToken] Aws sessionToken
                 * @property {string} [expiration] Aws expiration
                 */
            ...
            Credentials.S3Post = (function() {
                 ...
                 * @memberof api.Credentials
                 * @interface IS3Post
                 * @property {string} [AWSAccessKeyId] S3Post AWSAccessKeyId
                 * @property {string} [policy] S3Post policy
                 * @property {string} [signature] S3Post signature
                 * @property {string} [acl] S3Post acl
                 */
        ...
        api.SecretboxRecord = (function() {
             ...
             * @property {Uint8Array} [encryptedData] SecretboxRecord encryptedData
             * @property {number} [counter] SecretboxRecord counter
             * @property {Uint8Array} [nonceRandom] SecretboxRecord nonceRandom
             */
        ...
        api.SyncRecord = (function() {
             ...
             * @property {api.SyncRecord.Action} [action] SyncRecord action
             * @property {Uint8Array} [deviceId] SyncRecord deviceId
             * @property {Uint8Array} [objectId] SyncRecord objectId
             * @property {api.SyncRecord.IBookmark} [bookmark] SyncRecord bookmark
             * @property {api.SyncRecord.ISite} [historySite] SyncRecord historySite
             * @property {api.SyncRecord.ISiteSetting} [siteSetting] SyncRecord siteSetting
             * @property {api.SyncRecord.IDevice} [device] SyncRecord device
             */
             ...
             * @member {string|undefined} objectData
             * @memberof api.SyncRecord
             * @instance
             */
            ...
            SyncRecord.verify = function verify(message) {
                ...
                if (message.historySite != null && message.hasOwnProperty("historySite")) {
                    ...
                    properties.objectData = 1;
                    error = $root.api.SyncRecord.Site.verify(message.historySite);
                    if (error)
                ...
                if (message.siteSetting != null && message.hasOwnProperty("siteSetting")) {
                    if (properties.objectData === 1)
                        return "objectData: multiple values";
                    properties.objectData = 1;
                    error = $root.api.SyncRecord.SiteSetting.verify(message.siteSetting);
                    if (error)
                ...
                if (message.device != null && message.hasOwnProperty("device")) {
                    if (properties.objectData === 1)
                        return "objectData: multiple values";
                    properties.objectData = 1;
                    error = $root.api.SyncRecord.Device.verify(message.device);
                    if (error)
                        return "device." + error;
                }
                return null;
            ...
            SyncRecord.Site = (function() {
                 ...
                 * @memberof api.SyncRecord
                 * @interface ISite
                 * @property {string} [location] Site location
                 * @property {string} [title] Site title
                 * @property {string} [customTitle] Site customTitle
                 * @property {number|Long} [lastAccessedTime] Site lastAccessedTime
                 * @property {number|Long} [creationTime] Site creationTime
                 * @property {string} [favicon] Site favicon
                 */
            ...
            SyncRecord.Bookmark = (function() {
                 ...
                 * @memberof api.SyncRecord
                 * @interface IBookmark
                 * @property {api.SyncRecord.ISite} [site] Bookmark site
                 * @property {boolean} [isFolder] Bookmark isFolder
                 * @property {Uint8Array} [parentFolderObjectId] Bookmark parentFolderObjectId
                 * @property {Uint8Array} [previousObjectId] Bookmark previousObjectId
                 * @property {Uint8Array} [nextObjectId] Bookmark nextObjectId
                 * @property {Array.<string>} [fields] Bookmark fields
                 * @property {boolean} [hideInToolbar] Bookmark hideInToolbar
                 */
            ...
            SyncRecord.SiteSetting = (function() {
                 ...
                 * @property {string} [hostPattern] SiteSetting hostPattern
                 * @property {number} [zoomLevel] SiteSetting zoomLevel
                 * @property {boolean} [shieldsUp] SiteSetting shieldsUp
                 * @property {api.SyncRecord.SiteSetting.AdControl} [adControl] SiteSetting adControl
                 * @property {api.SyncRecord.SiteSetting.CookieControl} [cookieControl] SiteSetting cookieControl
                 * @property {boolean} [safeBrowsing] SiteSetting safeBrowsing
                 * @property {boolean} [noScript] SiteSetting noScript
                 * @property {boolean} [httpsEverywhere] SiteSetting httpsEverywhere
                 * @property {boolean} [fingerprintingProtection] SiteSetting fingerprintingProtection
                 * @property {boolean} [ledgerPayments] SiteSetting ledgerPayments
                 * @property {boolean} [ledgerPaymentsShown] SiteSetting ledgerPaymentsShown
                 * @property {Array.<string>} [fields] SiteSetting fields
                 */
