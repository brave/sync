 ...
 * @returns {Uint8Array}
 */
module.exports.stringToByteArray = function (str/* : string */) {
 ...
 * @returns {string}
 */
module.exports.byteArrayToString = function (buffer/* : Uint8Array */) {
  if (typeof window === 'object' && window.TextDecoder) {
    // Browser
    let decoder = new window.TextDecoder()
    return decoder.decode(buffer) // utf-8
  } else {
    return (Buffer.from(buffer.buffer)).toString()
  }
}
